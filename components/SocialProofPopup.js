      ...
      content={
        <div className="mt-8 mb-6">
          ...
          <div className="mt-12 mb-5 text-center">
            <Button
              ...
              onClick={() => {
                if (formData.handle === "") {
                  setDisplayedError(
                    "Please add a handle to verify on Twitter. Click outside this modal to go back."
                  );
                  return;
                }
          ...
          <div className="text-center">
            <button
              className="font-mono underline font-light text-kong-border hover:text-white"
              onClick={wrappedSign}
            >
              {loading ? (
                <ScaleLoader color="black" height={12} width={3} />
              ) : (
